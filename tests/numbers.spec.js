...
describe("2 - Implemente os casos de teste para a função `numbers`", () => {
  ...
  it("Verifica se a função retorna `false` quando o array contém um itém que não é do tipo Numero", () => {
    expect(numbers([1, 2, "3", 4, 5])).toBeFalsy();
  });
  // Escreva um teste em que a função recebe [1, 'a', 3] e retorna false
  it("Verifica se a funão retorna `false` quando o array contém um itém que não é do tipo Numero", () => {
    expect(numbers([1, "a", 3])).toBeFalsy();
  });
  // Escreva um teste em que a função recebe [' '] e retorna false
  it("Verifica se a função retorna false quando o array tem uma '' vazia", () => {
